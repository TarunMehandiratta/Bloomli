...
public class YouMayLikeSimilarAdapter extends RecyclerView.Adapter<YouMayLikeSimilarAdapter.ViewHolder> {

    private Activity activity;
    private LayoutInflater inflater;

    public YouMayLikeSimilarAdapter(Activity activity) {
