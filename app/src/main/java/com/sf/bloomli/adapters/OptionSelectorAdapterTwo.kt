...
class OptionSelectorAdapterTwo  (var context : Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.itmes_radio_button_two, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(selectedPosition == position){
            ...
            holder.itemView.worldCup.visibility = View.GONE
        }
