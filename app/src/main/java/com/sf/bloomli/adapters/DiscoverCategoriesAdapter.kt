...
class DiscoverCategoriesAdapter(var context : Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (selectedPosition2==0){
            ...
            holder.itemView.cate_adapter_text.setText("Spirituality")
            holder.itemView.icon.setImageResource(R.drawable.star_round_iocn)

        }
        else if (selectedPosition2==2){
            holder.itemView.cate_adapter_text.setText("Relationships")
